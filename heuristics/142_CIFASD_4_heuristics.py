...
def infotodict(seqinfo):
    ...
    """
    t1 = create_key('sub-{subject}/anat/sub-{subject}_acq-{acq}_T1w')
    t2 = create_key('sub-{subject}/anat/sub-{subject}_acq-{acq}_T2w')
    ...
    sbref_dwi = create_key('sub-{subject}/dwi/sub-{subject}_acq-{acq}_run-{item:02d}_sbref')
