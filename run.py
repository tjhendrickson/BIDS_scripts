...
if args.subj_id and not args.ses_id:
    if len(glob(args.dicom_dir + "/*" + args.subj_id + "*")) == 1:
        ...
        """
        if os.path.isdir(glob(args.dicom_dir + "/*" + args.subj_id + "*")[0]):
...
#just ses id
    ...
    if len(glob(args.dicom_dir + "/*" + args.ses_id + "*")) == 1:
        ...
        """
        if os.path.isdir(glob(args.dicom_dir + "/*" + args.ses_id + "*")[0]):
...
# subject id and session id
    ...
    if len(glob(args.dicom_dir + "/*" + args.subj_id + "*/*" + args.ses_id + "*")) == 1:
        ...
        """
        if os.path.isdir(glob(args.dicom_dir + "/*" + args.subj_id + "*/*" + args.ses_id + "*")[0]):
        ...
        """
        if os.path.isdir(glob(args.dicom_dir + "/*" + args.ses_id + "*/*" + args.subj_id + "*")[0]):
